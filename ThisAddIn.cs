...
namespace PresPio
    ...
    public partial class ThisAddIn
        ...
        public TaskPanelController GetCurTaskPane()
            {
            return Public_Function.TaskPaneManager.Instance.GetCurrentController();
            }

        // 设置taskpanel初始化状态为true
        public void SetTaskPaneStatus()
            {
            // 这个方法现在可以移除，因为显示状态由TaskPaneManager管理
            }
        ...
        public void CloseCustomTaskPane()
            {
            Public_Function.TaskPaneManager.Instance.CloseTaskPane();
            }
        ...
        private void ThisAddIn_Shutdown(object sender, EventArgs e)
            {
            Public_Function.TaskPaneManager.Instance.CloseAllTaskPanes();
            // 取消订阅选中幻灯片事件
            Application.WindowSelectionChange -= Application_WindowSelectionChange;
            // 取消订阅形状大小改变事件
            // Application.AfterShapeSizeChange -= Application_AfterShapeSizeChange;
