...
namespace PresPio
    ...
    public partial class Wpf_shapeCohesion:HandyControl.Controls.Window
        ...
        public void LoadImage()
            ...
            {
                Properties.Resources.shp__1_,
                Properties.Resources.shp__2_,
                Properties.Resources.shp__3_,
                Properties.Resources.shp__4_,
                Properties.Resources.shp__5_,
                Properties.Resources.shp__6_,
                Properties.Resources.shp__7_,
                Properties.Resources.shp__8_
            };

            // 创建位图源数组
            BitmapSource[] bitmapSources = new BitmapSource[bitmaps.Length];

            // 将位图资源转换为位图源
            for (int i = 0 ; i < bitmaps.Length ; i++)
                {
                bitmapSources[i] = Imaging.CreateBitmapSourceFromHBitmap(
            ...
            // 将位图源设置为图像控件的源
            image1.Source = bitmapSources[0];
            image2.Source = bitmapSources[1];
            image3.Source = bitmapSources[2];
            image4.Source = bitmapSources[3];
            image5.Source = bitmapSources[4];
            image6.Source = bitmapSources[5];
            image7.Source = bitmapSources[6];
            image8.Source = bitmapSources[7];
            }
